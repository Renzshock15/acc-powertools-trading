    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        <form class="" method="post" action="../add_inventory">
                            @csrf
                            <div class="container">
                                <div class="form-group mb-3">
                                    <label class="col-md-12 p-0">Product Id</label>
                                    <div class="col-md-12 p-0">
                                        <input type="text" placeholder="e.g ABCD" class="form-control p-0 border-0 bg-white" name="product_id" id="product_id" value="{{ $product_info['product_id'] }}" autocomplete="off" readonly>
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="example-email" class="col-md-12 p-0">Product Name</label>
                                    <div class="col-md-12 p-0">
                                        <input type="text" class="form-control p-0 border-0 bg-white" name="product_name" id="product_name" value="{{ $product_info['product_name'] }}" autocomplete="off" readonly>
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                    <label class="col-md-12 p-0">Quantity</label>
                                    <div class="col-md-12 p-0">
                                        <input type="number" class="form-control" name="product_qty" id="product_qty" value="0">
                                    </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="event.preventDefault();
                                                     document.getElementById('redirect-to-products').submit();">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="event.preventDefault();
                                                     document.getElementById('redirect-to-products').submit();">Close</button>
            </div>
            <form id="redirect-to-products" action="{{ route('product_list') }}" method="POST" style="display: none;">
                @csrf
            </form>
        </div>
    </div>
...
<div class="modal fade" id="inventory-error" tabindex="-1" role="dialog" aria-labelledby="success" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"></h5>
