    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14 mt-1">Unbox Inventory</h4>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        <form class="" method="post" action="../explode_inventory">
                            @csrf
                            <div class="container">
                                <div class="form-group mb-3">
                                    <label class="col-md-12 p-0">Inventory Id</label>
                                    <div class="col-md-12 p-0">
                                        <input type="text" placeholder="e.g ABCD" class="form-control bg-white" name="inventory_id" id="inventory_id" value="{{ $data['inventory']->id }}" autocomplete="off" readonly>
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="example-email" class="col-md-12 p-0">Product Name</label>
                                    <div class="col-md-12 p-0">
                                        <input type="text" class="form-control bg-white" name="product_name" id="product_name" value="{{ $data['inventory']->product->name }}" autocomplete="off" readonly>
                                    </div>
                                </div>
                                <div class="form-group mb-3">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close close-redirect" data-dismiss="modal">
            ...
            <div class="modal-body">
                <div class="text-center text-success">
                    ...
                    <div class="text-dark mt-3">
                        <h5>Inventory has been exploded</h5>
                    </div>
                </div>
            </div>
...
@if(Session::has('explode-success'))
<script>
    $('#success').modal('show');
</script>
@endif
