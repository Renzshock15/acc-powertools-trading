        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="white-box">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="box-title">For Receive</h3>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($transfer_transaction->transaction_type->type_name === 'Transfer')
                                        <a href="recieve_stocks/{{ $transfer_transaction->id }}"><button class="btn btn-info text-white" name="" id="" data-id="" data-label=""><i class="far fa-list-alt"></i></button></a>
                                        @else
                                        <a href="recieve_delivery/{{ $transfer_transaction->id }}"><button class="btn btn-info text-white" name="" id="" data-id="" data-label=""><i class="far fa-list-alt"></i></button></a>
                                        @endif
                                    </td>
                                    <td class="text-center">
