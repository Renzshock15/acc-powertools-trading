    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14 mt-1">Edit Locations</h4>
            </div>
                    ...
                    <form action="../update_locations" method="post">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="col-md-12 p-0">
                                <input type="hidden" class="form-control" name="store_id" id="store_id" value="{{ old('store_id') }}" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group mb-4">
...
<script>
    ...
    function get_data() {
        ...
        $('#location_name').val("{{ $data['store']->name }}");
        $('#street_name').val("{{ $data['store']->street }}");
        $('#city_name').val("{{ $data['store']->city }}");
        $('#province_name').val("{{ $data['store']->province }}");
        $('#access_name').val("{{ $data['store']->access_id }}");
    }
</script>
