    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14 mt-3 mb-1">Delivery Items</h4>
            </div>
            ...
            <div class="col-sm-4">
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a href="../generate_delivery_pdf/{{ $data['transaction']->id }}" target="blank" class="btn btn-warning mb-2 float-right m-l-20  waves-effect waves-light"><i class="far fa-file-pdf" aria-hidden="true"></i> PDF</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
