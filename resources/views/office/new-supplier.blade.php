        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <div class="other-menu">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="suppliers" aria-expanded="false" style="color:#febf52; font-weight:500;"><i class="fas fa-user-friends ml-3" aria-hidden="true" style="color:#febf52;"></i><span class="hide-menu">Suppliers</span></a></li>
                </div>
    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14 mt-1">Create Supplier</h4>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-sm-6">
                <div class="white-box">
                    ...
                    <form action="save_supplier" method="post">
                        @csrf
                        <div class="form-group mb-4">
                            <div class="col-md-12 p-0">
                                <input type="hidden" class="form-control" name="supplier_id" id="supplier_id" value="{{ old('supplier_id') }}" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <label class="col-md-12 p-0">Name</label>
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" name="supplier_name" id="supplier_name" value="{{ old('supplier_name') }}" autocomplete="off">
                            </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" name="supplier_address" id="supplier_address" value="{{ old('supplier_address') }}" autocomplete="off">
                            </div>
