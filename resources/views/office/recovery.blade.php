...
<div class="page-wrapper">
    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14 mt-1">Recovery</h4>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-6">
                <div class="white-box">
                    <h3 class="box-title">Reset Form</h3>
                    <form action="../recover_user" method="post">
                        @csrf
                        <div class="form-group mb-4">

                            <div class="col-md-12 p-0">
                                <input type="hidden" class="form-control bg-white" name="user_id" id="user_id" value="{{ old('user_id') }}" autocomplete="off">
                            </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control bg-white" name="first_name" id="first_name" value="{{ old('first_name') }}" autocomplete="off" readonly>
                            </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control bg-white" name="middle_name" id="middle_name" value="{{ old('middle_name') }}" autocomplete="off" readonly>
                            </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control bg-white" name="last_name" id="last_name" value="{{ old('last_name') }}" autocomplete="off" readonly>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center text-success">
                    <i class="fas fa-check-circle fa-4x"></i>
                    <div class="text-dark mt-3">
                        <h5>User successfully recovered</h5>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
