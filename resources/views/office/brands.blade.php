    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark active other-button" role="button" aria-expanded="false" style="color:#febf52; font-weight:500;"><i class="fas fa-layer-group" aria-hidden="true" style="color:#febf52;"></i><span class="hide-menu">Others</span><span><i class="fas fa-caret-down rotate"></i></span></a></li>
                <div class="other-menu">
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark active" href="brands" aria-expanded="false" style="color:#febf52; font-weight:500;"><i class="fa fa-tags ml-3" aria-hidden="true" style="color:#febf52;"></i><span class="hide-menu">Brands</span></a></li>
    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14 mt-1">Brands</h4>
            </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <form method="post" action="brands">
                    @csrf
                    <div class="input-group">
                        <input type="text" placeholder="Search brand" class="form-control mt-2" id="search_item" name="search_item" autocomplete="off">
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a href="new_brand" class="btn btn-dark mb-2 float-right m-l-20  waves-effect waves-light"><i class="fa fa-tags" aria-hidden="true"></i> New</a>
                        </div>
                    </div>
                        ...
                        <table class="table" id="product_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="">{{ $brand->supplier->name }}</td>
                                    <td class="">
                                        <div class="bg-c-{{$brand->brand_color->brand_color}} p-2 text-{{$brand->brand_color->text_color}}">{{ $brand->brand_color->brand_color }}</div>
                                    </td>
                                    <td class="text-center">
                                        <a class="btn btn-primary text-white" href="edit_brand/{{$brand->id}}" name="" id=""><i class="far fa-edit"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
