        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <div class="other-menu">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark active" href="suppliers" aria-expanded="false" style="color:#febf52; font-weight:500;"><i class="fas fa-user-friends ml-3" aria-hidden="true" style="color:#febf52;"></i><span class="hide-menu">Suppliers</span></a></li>
                </div>
    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14 mt-1">Suppliers</h4>
            </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <form method="post" action="suppliers">
                    @csrf
                    <div class="input-group">
                        <input type="text" placeholder="Search supplier" class="form-control mt-2" id="search_item" name="search_item" autocomplete="off">
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a href="new_supplier" class="btn btn-dark mb-2 float-right m-l-20  waves-effect waves-light"><i class="fa fa-user-friends" aria-hidden="true"></i> New</a>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-primary text-white" href="edit_supplier/{{$supplier->id}}" name="" id=""><i class="far fa-edit"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
