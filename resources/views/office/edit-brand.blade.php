    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link other-button" role="button" aria-expanded="false" style="color:#febf52; font-weight:500;"><i class="fas fa-layer-group" aria-hidden="true" style="color:#febf52;"></i><span class="hide-menu">Others</span><span><i class="fas fa-caret-down rotate"></i></span></a></li>
                <div class="other-menu">
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="../brands" aria-expanded="false" style="color:#febf52; font-weight:500;"><i class="fa fa-tags ml-3" aria-hidden="true" style="color:#febf52;"></i><span class="hide-menu">Brands</span></a></li>
                ...
                <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark active admin-button" role="button" aria-expanded="false"><i class="fa fa-cogs" aria-hidden="true"></i><span class="hide-menu">Admin</span><span><i class="fas fa-caret-down rotate"></i></span></a></li>
                <div class="admin-menu">
                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark active" href="../users" aria-expanded="false"><i class="fa fa-users ml-3" aria-hidden="true"></i><span class="hide-menu">Users</span></a></li>
    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14 mt-1">Brand</h4>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-sm-6">
                <div class="white-box">
                    ...
                    <form action="../update_brands" method="post">
                        @csrf
                        <div class="form-group mb-4">

                            <div class="col-md-12 p-0">
                                <input type="hidden" class="form-control" name="brand_id" id="brand_id" value="{{ old('brand_id') }}" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <label class="col-md-12 p-0">Name</label>
                            <div class="col-md-12 p-0">
                                <input type="text" class="form-control" name="brand_name" id="brand_name" value="{{ old('brand_name') }}" autocomplete="off">
                            </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="col-sm-12 px-0">
                                <select class="form-control " name="supplier_name" id="supplier_name">
                                    ...
                                    @if(old('supplier_name') == $supplier->id)
                        ...
                        <div class="form-group mb-4">
                            <label class="col-sm-12 p-0">Color</label>
                            <div class="col-sm-12 px-0">
                                <select class="form-control " name="color_name" id="color_name">
                                    <option selected="">Select</option>
                                    @foreach ($data['colors'] as $color)
                                    @if(old('color_name') == $color->name)
                        ...
                        <div class="form-group mb-4">
                            <label class="col-sm-12 p-0">Text Color</label>
                            <div class="col-sm-12 px-0">
                                <select class="form-control " name="text_color" id="text_color">
                                    <option selected="">Select</option>

                                    @if(old('text_color') == $color->name)
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center text-success">
                    <i class="fas fa-check-circle fa-4x"></i>
                    <div class="text-dark mt-3">
                        <h5>Brand successfully updated</h5>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    function get_data() {
        ...
        $('#supplier_name').val("{{ $data['brand']->supplier_id }}");
        $('#color_name').val("{{ $data['brand']->brand_color->brand_color }}");
        $('#text_color').val("{{ $data['brand']->brand_color->text_color }}");
    }
</script>
@if(Session::has('update-brand'))
<script>
    $('#success').modal('show');
</script>
@endif