    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14 mt-3 mb-1">Deliveries</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group mb-4">
                                <label class="col-sm-12 p-0">Packing List</label>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group mb-4">
                                <label class="col-sm-12 p-0">Store</label>
                                <div class="col-sm-12 px-0">
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a href="create_deliveries" class="btn btn-primary mb-2 float-right m-l-20  waves-effect waves-light"><i class="fa fa-plus-circle" aria-hidden="true"></i> Create</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <div id="tbody">
                            @include('office.deliveries-data')
                        </div>
...
<div class="modal fade" id="show_product_details" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">
                    <div id="product_title_name"></div>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body p-0">
                <div class="">
                    <img width="100%" alt="user" src="" id="productImg">
                </div>
                <div class="p-2">
...
<script>
    $(document).ready(function() {
        ...
        function fetch_data(page, query, brand) {
            $.ajax({
                url: "/office/fetch_delivery_transactions?page=" + page + "&query=" + query + "&brand=" + brand,
        ...
        $(document).on('click', '#cancel_transaction', function() {
            ...
            if (user_role === 'Full') {
                ...
                window.location.href = "cancel_delivery_transaction/" + transaction_id;
            } else {
