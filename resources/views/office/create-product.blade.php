    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14">Add New</h4>
            </div>
                    ...
                    <div class="card-body">
                        <form class="" method="post" action="create">
                            ...
                            <div class="form-group mb-4 float-right">
                                <div class="col-sm-12 px-0">
                                    <button class="btn btn-dark text-white" name="saveProduct" id="save_product">Save Product</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="modal-body">
                <div class="text-center text-success">
                    ...
                    <div class="text-dark mt-3">
                        <h5>New product has been successfully added</h5>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
@include('includes.jquery.office.create-product')
