    ...
    <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title text-uppercase font-medium font-14 mt-3 mb-1">Products</h4>
            </div>
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a href="create" class="btn btn-outline-warning mb-2 float-right m-l-20  waves-effect waves-light"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <div id="tbody">
                            @include('office.product-data')
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        function fetch_data(page, query, brand) {
            $.ajax({
                url: "/office/fetch_product_data?page=" + page + "&query=" + query + "&brand=" + brand,
