...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="../images/app/ACCWeb.jpg">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <script src="../js/chart.js"></script>
    <title>Acc</title>
    <!-- Custom CSS -->
    <link href="../css/style.min.css" rel="stylesheet">
    <link href="../css/homecard.css" rel="stylesheet">
    <link href="../css/loading-logo.css" rel="stylesheet">
    <link href="../css/font_awsome5/css/all.css" rel="stylesheet">
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand justify-content-center" href="">
                        ...
                        <b class="logo-icon mt-2">
                            <!-- Dark Logo icon -->
                            <img src="../images/app/ACC1.svg" width="100" alt="homepage" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                    ...
                    <ul class="navbar-nav ml-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="../images/uploads/profiles/{{ Auth::user()->image }}" alt="user-img" width="36" class="img-circle"><span class="text-white font-medium">{{Auth::user()->first_name}}</span></a>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
                        <!-- ============================================================== -->
